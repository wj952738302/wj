...
import wj.bean.Master;
import wj.util.BaseHibernateDAO;

/**
 	* A data access object (DAO) providing persistence and search support for Master entities.
...
public class MasterDAO extends BaseHibernateDAO  {
    ...
    public Master findById( java.lang.Integer id) {
        ...
        try {
            Master instance = (Master) getSession()
                    .get("wj.bean.Master", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Master merge(Master detachedInstance) {
        ...
        try {
            Master result = (Master) getSession()
